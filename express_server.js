...
// creates new url if user is logged in
...
//add url to user's url database with user's id
...
//creat a short url and add it to url database with user id
...
//delets urls if user is logged in and is the owner
...
//login using email and hashed password if not email or user return error
